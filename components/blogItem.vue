<template>
  <div>
    ...
    >
      ...
      <div
        class="mt-auto flex flex-col lg:flex-row-reverse items-start lg:items-center lg:justify-end"
      >
        <NuxtImg
        ...
        <div class="lg:absolute lg:top-0 lg:right-full mr-2 mt-2">
          <dl>
            ...
            <dd
              class="text-sm leading-6 dark:text-slate-400 lg:mr-8 lg:whitespace-nowrap font-bold"
            >
