import { S as withBase, w as withLeadingSlash, n as joinURL, q as withoutTrailingSlash, v as hash } from '../nitro/nitro.mjs';
import { h as useRuntimeConfig } from './server.mjs';
import { u as useRequestEvent, a as useContentPreview } from './preview-3xgQogEH.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BHkwbLZI.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DhC92CFp.mjs.map
