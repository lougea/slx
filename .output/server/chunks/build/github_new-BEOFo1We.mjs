...
const github_new = { render() {
  return h(NuxtIcon, { icon: { render }, name: "github_new" });
} };

export { github_new as default, render };
//# sourceMappingURL=github_new-BEOFo1We.mjs.map
