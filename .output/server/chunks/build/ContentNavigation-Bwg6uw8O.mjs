...
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-DhC92CFp.mjs';
import { a as useContentPreview } from './preview-3xgQogEH.mjs';
import { l as useState, h as useRuntimeConfig } from './server.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-BHkwbLZI.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-Bwg6uw8O.mjs.map
