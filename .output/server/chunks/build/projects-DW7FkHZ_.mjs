import { mergeProps, unref, resolveComponent, createElementBlock, openBlock, createElementVNode, useSSRContext } from 'vue';
import { G as GithubNewIcon } from './github_new-DHGg_ayV.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div><div class="flex flex-row justify-between"><div class="mx-1"><a class="text-sm text-gray-500 transition hover:text-gray-600" target="_blank" rel="noopener noreferrer"${ssrRenderAttr("href", $data.projectHref)}><span class="sr-only"></span>`);
  _push(ssrRenderComponent(_component_ExternalIcon, { class: "w-6 h-6 text-black" }, null, _parent));
  _push(`</a></div><div class="mx-1"><a class="text-sm text-gray-500 transition hover:text-gray-600" target="_blank" rel="noopener noreferrer"${ssrRenderAttr("href", $data.projectGithub)}><span class="sr-only">github</span>`);
  _push(ssrRenderComponent(_component_GithubIcon, { class: "w-6 h-6 text-black" }, null, _parent));
  _push(`</a></div></div></div><h2 class="text-2xl font-bold leading-8 tracking-tight mb-3">${ssrInterpolate($data.projectTitle)}</h2><p class="prose text-gray-500 max-w-none dark:text-gray-400 mb-3">${ssrInterpolate($data.projectDescription)}</p><div class="flex flex-row justify-between"><div class="text-gray-400 text-sm font-extralight">${ssrInterpolate($data.projectTech1)} \u2022 ${ssrInterpolate($data.projectTech2)} \u2022 ${ssrInterpolate($data.ProjectTech3)}</div></div></div></div></div>`);
}
...
//# sourceMappingURL=projects-DW7FkHZ_.mjs.map
